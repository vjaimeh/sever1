	...
	<div class="container">
		<div class="inner">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        Todos los derechos reservados tlanti &copy; 
                    </div>
		    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <span style="float:right">
			    Diseñado por <a href="http://www.mediawave.com.mx" target="_blank" title="Creator" style="text-decoration: underline;"> Mediawave|Diseño|Web|Multimedia</a>
			</span>
                    </div>
