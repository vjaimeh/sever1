...
<div id="container">
    <div id="header">
  <div class="div1">
    <div class="div2"><img style="height:50px; margin-top:-15px;" src="http://tlati.com/image/data/logo_tlanti.png" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /></div>
    <?php if ($logged) { ?>
