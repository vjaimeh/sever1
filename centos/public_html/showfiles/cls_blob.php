...
class cls_blob {
    ...
    const DB_NAME = 'fileslinks';
    const DB_USER = 'fileslinks';
    const DB_PASSWORD = '2rjDvaGvk1KaD9cw';
    ...
    public function selectBlob($id) {
        ...
        $sql = "SELECT `tbl_images`.`img` FROM `tbl_links` 
inner join `tbl_images` on `tbl_links`.`tbl_images_id` = tbl_images.id
WHERE `tbl_links`.`link` like :id ;";
